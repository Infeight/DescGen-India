...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 pb-24 pt-28 text-center">
        {/* Badge */}
        <div className="mb-6 rounded-full border border-fuchsia-500/20 bg-white/5 px-5 py-2 text-sm text-fuchsia-300 backdrop-blur-xl">
        ...
        {/* Marketplace Logos */}
        <div className="mt-20 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
        ...
        {/* Dashboard Preview */}
        <div className="relative mt-20 w-full max-w-6xl overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-4 shadow-2xl backdrop-blur-xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            {/* Center AI */}
            <div className="flex items-center justify-center rounded-2xl border border-fuchsia-500/20 bg-gradient-to-b from-fuchsia-500/10 to-cyan-500/10 p-5">
              <div className="text-center">
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-r from-fuchsia-500 to-cyan-500 text-3xl">
                  ✨
                </div>
