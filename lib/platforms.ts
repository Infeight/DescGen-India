...
export const PLATFORM_RULES: Record<string, PlatformRule> = {
  ...
  Instagram: {
    ...
    strictRules: [
      ...
      "Use 2-3 emojis max — they enhance not clutter",
      ...
      "End every variant with 3-5 niche hashtags on a new line (e.g. #CottonKurti #WomenEthnicWear #SummerFashionIndia) — never generic tags like #Fashion #Love #Style",
    ],
